...
def dat(update):
    ...
    try:
        if "#AMP" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.AMP-BTC", shell=True)
        ...
        if "#ARDR" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.ARDR-BTC", shell=True)
        ...
        if "#BCH" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.BCH-BTC", shell=True)
        ...
        if "#BCN" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.BCN-BTC", shell=True)
        ...
        if "#BCY" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.BCY-BTC", shell=True)
        ...
        if "#BELA" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.BELA-BTC", shell=True)
        ...
        if "#BLK" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.BLK-BTC", shell=True)
        ...
        if "#BTCD" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.BTCD-BTC", shell=True)
        ...
        if "#BTM" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.BTM-BTC", shell=True)
        ...
        if "#BTS" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.BTS-BTC", shell=True)
        ...
        if "#BURST" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.BURST-BTC", shell=True)
        ...
        if "#CLAM" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.CLAM-BTC", shell=True)
        ...
        if "#CVC" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.CVC-BTC", shell=True)
        ...
        if "#DASH" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.DASH-BTC", shell=True)
        ...
        if "#DCR" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.DCR-BTC", shell=True)
        ...
        if "#DGB" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.DGB-BTC", shell=True)
        ...
        if "#DOGE" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.DOGE-BTC", shell=True)
        ...
        if "#EMC2" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.EMC2-BTC", shell=True)
        ...
        if "#ETC" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.ETC-BTC", shell=True)
        ...
        if "#ETH" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.ETH-BTC", shell=True)
        ...
        if "#EXP" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.EXP-BTC", shell=True)
        ...
        if "#FCT" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.FCT-BTC", shell=True)
        ...
        if "#FLDC" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.FLDC-BTC", shell=True)
        ...
        if "#FLO" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.FLO-BTC", shell=True)
        ...
        if "#GAME" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.GAME-BTC", shell=True)
        ...
        if "#GAS" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.GAS-BTC", shell=True)
        ...
        if "#GNO" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.GNO-BTC", shell=True)
        ...
        if "#GNT" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.GNT-BTC", shell=True)
        ...
        if "#GRC" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.GRC-BTC", shell=True)
        ...
        if "#HUC" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.HUC-BTC", shell=True)
        ...
        if "#LBC" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.LBC-BTC", shell=True)
        ...
        if "#LSK" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.LSK-BTC", shell=True)
        ...
        if "#LTC" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.LTC-BTC", shell=True)
        ...
        if "#MAID" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.MAID-BTC", shell=True)
        ...
        if "#NAV" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.NAV-BTC", shell=True)
        ...
        if "#NEOS" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.NEOS-BTC", shell=True)
        ...
        if "#NMC" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.NMC-BTC", shell=True)
        ...
        if "#NXC" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.NXC-BTC", shell=True)
        ...
        if "#NXT" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.NXT-BTC", shell=True)
        ...
        if "#OMG" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.OMG-BTC", shell=True)
        ...
        if "#OMNI" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.OMNI-BTC", shell=True)
        ...
        if "#PASC" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.PASC-BTC", shell=True)
        ...
        if "#PINK" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.PINK-BTC", shell=True)
        ...
        if "#POT" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.POT-BTC", shell=True)
        ...
        if "#PPC" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.PPC-BTC", shell=True)
        ...
        if "#RADS" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.RADS-BTC", shell=True)
        ...
        if "#REP" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.REP-BTC", shell=True)
        ...
        if "#RIC" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.RIC-BTC", shell=True)
        ...
        if "#SBD" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.SBD-BTC", shell=True)
        ...
        if "#SC" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.SC-BTC", shell=True)
        ...
        if "#STEEM" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.STEEM-BTC", shell=True)
        ...
        if "#STORJ" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.STORJ-BTC", shell=True)
        ...
        if "#STR" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.STR-BTC", shell=True)
        ...
        if "#STRAT" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.STRAT-BTC", shell=True)
        ...
        if "#SYS" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.SYS-BTC", shell=True)
        ...
        if "#VIA" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.VIA-BTC", shell=True)
        ...
        if "#VRC" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.VRC-BTC", shell=True)
        ...
        if "#VTC" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.VTC-BTC", shell=True)
        ...
        if "#XBC" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.XBC-BTC", shell=True)
        ...
        if "#XCP" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.XCP-BTC", shell=True)
        ...
        if "#XEM" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.XEM-BTC", shell=True)
        ...
        if "#XMR" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.XMR-BTC", shell=True)
        ...
        if "#XPM" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.XPM-BTC", shell=True)
        ...
        if "#XRP" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.XRP-BTC", shell=True)
        ...
        if "#XVC" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.XVC-BTC", shell=True)
        ...
        if "#ZEC" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.ZEC-BTC", shell=True)
        ...
        if "#ZRX" in data:
            ...
            subprocess.call("./zenbot.sh buy --markdown_buy_pct=-1 poloniex.ZRX-BTC", shell=True)
